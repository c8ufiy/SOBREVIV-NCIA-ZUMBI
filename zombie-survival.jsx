...
import { Skull, Heart, Target, Award, PlayCircle, RotateCcw, Volume2, VolumeX, Zap } from 'lucide-react';
...
export default function ZombieSurvivalGame() {
  ...
  const gameLoop = () => {
    ...
    // Continuous shooting when mouse is held
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        {gameState === 'menu' && (
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300">Sobreviva às ondas de zumbis!</p>
            </div>

            <div className="bg-black/50 rounded-lg p-6 text-left max-w-md mx-auto space-y-3 text-gray-300">
              <h2 className="text-2xl font-bold text-white mb-4">Como Jogar:</h2>
              <p><strong className="text-white">WASD / Setas:</strong> Mover</p>
              <p><strong className="text-white">Mouse:</strong> Mirar</p>
              <p><strong className="text-white">Segurar Mouse:</strong> Tiro automático</p>
              <p><strong className="text-cyan-400">ESPAÇO:</strong> Habilidade Especial (explosão)</p>
              <p className="text-sm text-yellow-400 mt-4">💡 Zumbis soltam munição aleatoriamente!</p>
              <p className="text-sm text-cyan-400">⚡ Ganhe cargas especiais ao completar ondas!</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-4">
            <div className="bg-black/70 rounded-lg p-4 flex justify-between items-center text-white">
              <div className="flex items-center gap-2">
                <Heart className="w-6 h-6 text-red-500" />
                <div className="w-48 bg-gray-700 rounded-full h-6">
                  <div 
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-2xl">{ammo}</span>
                </div>
                    ...
                    {[...Array(5)].map((_, i) => (
                      <div
                        ...
                        className={`w-3 h-6 rounded ${
                          i < specialCharges ? 'bg-cyan-400' : 'bg-gray-600'
                        }`}
                      />
                    ))}
                  </div>
              ...
              <div className="flex items-center gap-4">
                <span className="text-xl">Onda: <strong className="text-red-400">{wave}</strong></span>
                <span className="text-xl">Pontos: <strong className="text-yellow-400">{score}</strong></span>
                <button
            ...
            <div className="text-center text-gray-400 text-sm space-y-1">
              <p>🎯 Sobreviva o máximo que puder! Cada onda fica mais difícil.</p>
              <p className="text-cyan-400">⚡ Pressione ESPAÇO para usar a habilidade especial ({specialCharges} disponíveis)</p>
            </div>
          </div>
        )}
        ...
        {gameState === 'gameOver' && (
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-2xl text-red-400">Você foi derrotado!</p>
            </div>

            <div className="bg-black/50 rounded-lg p-8 max-w-md mx-auto space-y-4">
              ...
              <div className="flex justify-between text-xl text-white">
                ...
                <span className="font-bold text-red-400">{wave - 1}</span>
              </div>
